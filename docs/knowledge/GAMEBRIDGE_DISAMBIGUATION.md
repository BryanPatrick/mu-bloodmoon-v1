...
3. **`admin.game-bridge.manage`** guards both the marketplace job list
   (C1) and the VIP delivery queue (transport feeder) — one permission, two
   systems.
