...
# Open questions (condensed pointer)

Full list with evidence: [`../OPEN_QUESTIONS.md`](../OPEN_QUESTIONS.md)
(`OQ-CTX-001` through `OQ-CTX-009`).

Still genuinely open as of this review package:
...
Closed/superseded: `OQ-CTX-001`, `OQ-CTX-002`, `OQ-CTX-003`.

**If you find a real, unresolved question this list doesn't cover, add
it** — that's exactly the kind of omission this review exists to catch.
