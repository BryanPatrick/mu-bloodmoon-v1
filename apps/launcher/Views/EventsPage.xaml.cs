...
public partial class EventsPage : UserControl, ILauncherPage
{
    ...
    {
        var bannerImage = await SlotImageResolver.ResolveAsync(_context, "events.activeBanner", _context.Slots.GetAssetId("events.activeBanner"), _context.Slots.GetImageState("events.activeBanner"), CancellationToken.None);
