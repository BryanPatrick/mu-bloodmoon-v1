...
beforeAll(async () => {
  ...
  // Open Beta Plan B (2026-09-18): this suite tests ledger correctness
  // through a real marketplace sale, not the beta gate itself -- opt in
  // explicitly rather than letting the new fail-closed default silently
  // skip the marketplace path. See marketplace-beta-gate.e2e-spec.ts for
  // the gate's own dedicated tests.
