...
```text
work/deploy/cpanel/bloodmoon-api-cpanel.zip
work/deploy/cpanel/bloodmoon-web-cpanel.zip
```

## Estado aplicado em 2026-07-16
...
- Zips enviados para a home do cPanel:
  - `/home/mubloodxz/bloodmoon-api-cpanel.zip`;
  - `/home/mubloodxz/bloodmoon-web-cpanel.zip`.
- Zips extraidos no cPanel:
  - `/home/mubloodxz/bloodmoon-api`;
  - `/home/mubloodxz/bloodmoon-web`.
...
- Versao Node.js: `22.17.0`
- Raiz do aplicativo: `/home/mubloodxz/bloodmoon-web`
...
1. Abrir `https://api.mubloodmoon.com.br/api/health`.
