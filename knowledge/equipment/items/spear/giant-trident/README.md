...
- ID: `spear-giant-trident`
- Nome canonico: Giant Trident
- Categoria: Spear
- Quem usa: Dark Knight, Fairy Elf, Magic Gladiator
...
- Detalhe normalizado: `apps/web/data/mu-equipment-details/spear.json`
- URL fonte: https://www.guiamuonline.com/spanish/items/spear/gianttrident.html
- URL imagem: https://www.guiamuonline.com/imagenes/items/spear/isp005_s.jpg
