# Blue Eye Elf Offensive Armor

## Identidade

- ID: `armor-blue-eye-elf-attack`
- Nome canonico: Blue Eye Elf Attack
- Categoria: Armor
- Quem usa: Fairy Elf
...
- URL fonte: https://www.guiamuonline.com/spanish/items/armor/blueeyeelfattack.html
