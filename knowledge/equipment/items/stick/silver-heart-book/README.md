...
- ID: `stick-silver-heart-book`
- Nome canonico: Silver Heart Book
- Categoria: Stick
- Quem usa: Summoner
...
- Detalhe normalizado: `apps/web/data/mu-equipment-details/stick.json`
- URL fonte: https://www.guiamuonline.com/spanish/items/stick/silverheartbook.html
- URL imagem: https://www.guiamuonline.com/imagenes/items/stick/silverheartbook.jpg
